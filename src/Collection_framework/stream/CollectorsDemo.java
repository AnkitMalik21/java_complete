...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        List<Integer>nums = Arrays.asList(1,2,2,3,4,4,6);
        Set<Integer> set = nums.stream().collect(Collectors.toSet());
        System.out.println(set);

        // 3. Collectiong to a specific collection
        ArrayDeque<String> collect = names.stream().collect(Collectors.toCollection(()-> new ArrayDeque<>()));

        // 4.Joining Strings
        //   Concatenated stream elements into single String
        ...
        //partition elements into two grroup (true and false) based on a predicate
        ...
        List<String> fruits = Arrays.asList("Aple","Banana","Cherry");
        System.out.println(fruits.stream().collect(Collectors.toMap(x->x.toUpperCase(),x->x.length())));

        // Example 6:
        List<String> words2 = Arrays.asList("apple","banana","apple","orange","orange","banana","apple");
